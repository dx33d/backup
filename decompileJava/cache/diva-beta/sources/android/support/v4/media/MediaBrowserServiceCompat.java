...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    private class ConnectionRecord {
        ...
        /* synthetic */ ConnectionRecord(MediaBrowserServiceCompat x0, AnonymousClass1 x1) {
            this();
        }
    }
    ...
    private class ServiceBinder extends Stub {
        ...
        /* synthetic */ ServiceBinder(MediaBrowserServiceCompat x0, AnonymousClass1 x1) {
            this();
        }
            ...
            if (MediaBrowserServiceCompat.this.isValidPackage(pkg, uid)) {
                ...
                MediaBrowserServiceCompat.this.mHandler.post(new Runnable() {
                    public void run() {
                        ...
                        ConnectionRecord connection = new ConnectionRecord(MediaBrowserServiceCompat.this, null);
                        connection.pkg = str;
