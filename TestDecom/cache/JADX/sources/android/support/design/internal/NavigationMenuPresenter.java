...
public class NavigationMenuPresenter implements MenuPresenter {
                ...
                for (int i = 0; i < totalSize; i++) {
                    ...
                    if (item.hasSubMenu()) {
                        ...
                        if (subMenu.hasVisibleItems()) {
                            ...
                            this.mItems.add(new NavigationMenuTextItem(item, null));
                            ...
                            for (int j = 0; j < size; j++) {
                                ...
                                if (subMenuItem.isVisible()) {
                                    ...
                                    this.mItems.add(new NavigationMenuTextItem(subMenuItem, null));
                                }
                            }
                            if (subMenuHasIcon) {
    ...
    private static class NavigationMenuHeaderItem implements NavigationMenuItem {
        ...
        /* synthetic */ NavigationMenuHeaderItem(AnonymousClass1 x0) {
            this();
        }
    }
    ...
    private static class NavigationMenuTextItem implements NavigationMenuItem {
        ...
        /* synthetic */ NavigationMenuTextItem(MenuItemImpl x0, AnonymousClass1 x1) {
            this(x0);
        }
