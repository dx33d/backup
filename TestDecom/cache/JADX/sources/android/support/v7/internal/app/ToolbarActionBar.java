...
public class ToolbarActionBar extends ActionBar {
    ...
    private final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        /* synthetic */ PanelMenuPresenterCallback(ToolbarActionBar x0, AnonymousClass1 x1) {
            this();
        }
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter.setCallback(new PanelMenuPresenterCallback(this, null));
