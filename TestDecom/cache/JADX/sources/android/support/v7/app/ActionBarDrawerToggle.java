...
public class ActionBarDrawerToggle implements DrawerListener {
    ...
    private static class HoneycombDelegate implements Delegate {
        ...
        /* synthetic */ HoneycombDelegate(Activity x0, AnonymousClass1 x1) {
            this(x0);
        }
    ...
    private static class JellybeanMr2Delegate implements Delegate {
        ...
        /* synthetic */ JellybeanMr2Delegate(Activity x0, AnonymousClass1 x1) {
            this(x0);
        }
    ...
    <T extends Drawable & DrawerToggle> ActionBarDrawerToggle(Activity activity, Toolbar toolbar, DrawerLayout drawerLayout, T slider, @StringRes int openDrawerContentDescRes, @StringRes int closeDrawerContentDescRes) {
        ...
        if (toolbar != null) {
            ...
            this.mActivityImpl = new JellybeanMr2Delegate(activity, null);
        } else if (VERSION.SDK_INT >= 11) {
            this.mActivityImpl = new HoneycombDelegate(activity, null);
        } else {
